      ...
      <section className="flex justify-center bg-red-300">
        <div className="w-11/12 pl-3 border border-blue-500 bg-amber-300">
          ...
          <div className="mb-7 ">
            ...
            <p className="my-3">
              The app was built partly as a training exercise, partly as a
              demonstration to potential employers of what I can do and partly
              to allow a family member to record his shareholdings rather than
              relying on the traditional pen and paper.
            </p>
            <p>
              Next.js 13 had come out recently and I was keen to use this, make
              lots of mistakes, get confused and so learn. Also, I had not used
              Tailwind to any great degree so this was a great opportunity to do
              so. In addition, having recently worked on a team building an app
              that took a thoroughly professional approach in terms of code
              structure and user verification I was keen to replicate it.
            </p>
          </div>
          <div className="mb-12">
            <p className="text-4xl">What does it do?</p>
            <p className="my-3">
              The core functionality allows a user to add into a table shares
              they own, inserting purchase price, and quantity. The app will
              then retrieve the closing price from the previous trading day
              (end-of-day) and display the value of each shareholding. A summary
              table shows the total value and cost and the overall profit/loss.
            </p>
            <p className="mb-3">
            ...
            <div className="flex mt-5  justify-center">
              <Image
                alt="finance app home page"
                width={800}
                height={800}
                className=""
                src="/finance-home.png"
              />
            </div>
            ...
            <div className="mt-5  flex justify-center">
              <Image
                ...
                height={800}
                className=" "
                src="/finance-create-account.png"
              />
            </div>
          ...
          <p className="mb-7">
            ...
            not seriously used previously, ensuring modularity by using
            components, and testing with vitest.
          </p>
          <div className="flex justify-end gap-3 pb-3 pr-3 font-medium">
            <Link
              href="https://github.com/johnhm22/finance-app"
              target="_blank"
            >
            ...
            <Link href="https://finance-app-puce.vercel.app/" target="_blank">
